...
//   void initState() {
//     super.initState();
//       imageUrl = "https://img.freepik.com/free-vector/illustration-gallery-icon_53876-27002.jpg?w=740&t=st=1703520381~exp=1703520981~hmac=fda9b147134991e9028f877ef241a1d2bed69d739686dbed5fcbbdff08d6d09a";
//       elePerUnit = "Loading...";
//       roomRent = "Loading...";
//       btCleaningCharge = "Loading...";
//       waterCharge = "Loading...";
...
//       if (await hasUserUploadedImage()) {
//         UiHelper.CustomAlertBox(
//             context, "Landlord can upload pricing only once if you want to change your pricing then you need to update by clicking on update button");
//         // return 'User can only upload one image.';
//       } else {
//         try {
//           String? llUid = user.uid;
//           UploadTask uploadTask = FirebaseStorage.instance
...
//                   ),
//                 ),
//                 // here i want to collect more information
//                 UiHelper.CustomTextField(
//                     elePerUnitController,
//                     "Electricity Cost/Unit",
//                     TextInputType.number, validator: (value) {
...
//                 UiHelper.CustomButton(() {
//                   if (_formKey.currentState?.validate() == true) {
//                     // here i want to call the function to save all data on firebase
//                     uploadPricing();
//                   } else {
//                     UiHelper.CustomAlertBox(
//                         (context), "Something went wrong ?");
...
//                   child: Column(
//                     children: [
//                       // here i want to show the data which should came from firebase
//                       Container(
...
//                               children: [
//                                 const SizedBox(height: 10),
//                                 UiHelper.customRowData("Electricity/Unit Rs:", elePerUnit),
//                                 const SizedBox(height: 10),
//                                 UiHelper.customRowData("Rent/Room Rs:", roomRent),
//                                 const SizedBox(height: 10),
//                                 UiHelper.customRowData("Toilet/Bathroom Cleaning Rs:", btCleaningCharge),
//                                 const SizedBox(height: 10),
//                                 UiHelper.customRowData("Water Charge Rs:", waterCharge),
//                                 const SizedBox(height: 10),
//                               ],
//                             ),
//                           )
...
//                 const SizedBox(height: 10),
//                 UiHelper.CustomButton(() {
//                   // here i want to call a update function for every data which i stored before when i clicked on it
//                   // after clicking update button data should open in same textfield and image picker which i use for store data
//                 }, "Update"),
//                 const SizedBox(height: 20),
//               ],
//             ),
